    ...
    <footer className="w-full relative overflow-hidden bg-slate-900 border-t border-slate-700 mt-auto min-h-[300px]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-30">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <h3 className="text-lg font-semibold text-white mb-4">Navigacija</h3>
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="#explore" className="text-gray-300 hover:text-blue-400 transition-colors inline-block">
                  Istraži
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-300">
              <li className="flex items-start gap-2">
                ...
                <span>info@exploreunizg.hr</span>
              </li>
              <li className="flex items-start gap-2">
                <svg className="w-5 h-5 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
